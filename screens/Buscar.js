...
export default function Menu({ navigation }) {
  ...
  const metodoGetData = async () => {
    try {
      const response = await fetch(`${URL_API}/balada/data/${dataBalada}`) // chamada para api
      ...
      if (!dadosBD.message) {
        ...
        setData(null)
        setErroMsg("Nenhuma balada encontrada com essa Data!")
      }
    } catch (error) {
    ...
    <>
      <SafeAreaView style={styles.container}>
        ...
        <View>
          ...
          >
            <Text style={styles.menuButtonText}>GET Data </Text>
          </TouchableOpacity>
        </View>
